...
//  KampusSGGW
//
//  Created by Pawel Sygnowski on 01/11/15.
...
class EventController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        FacebookGraphAPI.getPosts("291726291971", successCallback: self.postsDownloadedCallback, failureCallback: self.showMessageBecauseErrorOccured)
    }
